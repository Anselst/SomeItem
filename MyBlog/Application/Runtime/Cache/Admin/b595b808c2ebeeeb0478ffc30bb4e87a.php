					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="/MyBlog/index.php/Admin/Index/del?id=<?php echo ($vo["id"]); ?>" class="ico del" onclick="return confirm('你要删除这篇文章么?');">删除</a><a href="/MyBlog/index.php/Admin/Index/add?id=<?php echo ($vo["id"]); ?>" class="ico edit">修改</a></td>
							</tr>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						<a href="/MyBlog/index.php/Admin/Index/add" class="add-button"><span>添加新的文章</span></a>
						<div class="cl">&nbsp;</div>
