        ...
        <div class="shell">
            ...
            <div id="navigation">
                <ul>
                    ...
                    <li><a href="/MyBlog/index.php/Admin/User/add" <?php if (HEADER==1)echo 'class="active"'; ?> ><span>
<?php if($_GET['id']){echo '修改文章';}else{echo '新建文章';} ?></span></a></li>
                    <li><a href="#" class=""><span>用户管理</span></a></li>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form">
                                    ...
                                    <!-- <p class="inline-field">
                                        ...
                                        <?php $__FOR_START_10683__=1;$__FOR_END_10683__=32;for($i=$__FOR_START_10683__;$i < $__FOR_END_10683__;$i+=1){ ?><option value=""><?php echo ($i); ?>日</option><?php } ?>
                                        </select>
                                        <select class="field size3">
                                        <?php $__FOR_START_28376__=1;$__FOR_END_28376__=13;for($i=$__FOR_START_28376__;$i < $__FOR_END_28376__;$i+=1){ ?><option value=""><?php echo ($i); ?>月</option><?php } ?>
                                        </select>
                                        <select class="field size3">
                                        <?php $__FOR_START_12849__=2017;$__FOR_END_12849__=2019;for($i=$__FOR_START_12849__;$i < $__FOR_END_12849__;$i+=1){ ?><option value=""><?php echo ($i); ?>年</option><?php } ?>
                                        </select>
                                    </p> -->
